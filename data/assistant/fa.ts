...
export const assistantCopyFa = {
  ...
  launcherAria: "باز کردن راهنمای محصول بوکان پایپ",
  closeAria: "بستن راهنما",
  quickAccess: "دسترسی سریع",
  minimizeAria: "کوچک کردن راهنما",
  resetAria: "پاک کردن جستجو",
  composerPlaceholder: "جستجوی محصول، راهنما یا صفحه…",
  composerSubmit: "جستجو",
  composerMaxLength: 80,
  panelAria: "راهنمای محصول و مراجع فنی بوکان پایپ",
  greeting: "بخش مورد نظر را انتخاب کنید تا صفحهٔ مربوط باز شود.",
  searchEmpty: "صفحه‌ای مطابق جستجو پیدا نشد. از بخش‌های زیر انتخاب کنید.",
  searchResults: "صفحات مرتبط",
  subtitle: "محصولات، مراجع فنی و فروش",
  lowConfidence: "دقیقاً متوجه نشدم دنبال کدام بخش هستید. یکی از گزینه‌های زیر را انتخاب کنید:",
  leadIntro: "برای استعلام قیمت یا تماس با واحد فروش، یکی از گزینه‌های زیر را انتخاب کنید:",
  ...
  leadNotConfigured: "لطفاً از دکمه استعلام قیمت استفاده کنید یا با واحد فروش تماس بگیرید.",
  leadValidationPhone: "لطفاً یک شماره تماس معتبر وارد کنید.",
  chooseProductQuestion: "لوله را برای چه کاربردی نیاز دارید؟",
  chooseProductUnsure: "برای انتخاب دقیق‌تر می‌توانید راهنمای فنی یا واحد فروش را ببینید.",
