...
export const enApplications: readonly ContentDocument[] = [
  app(
    ...
    "Municipal, rural and industrial water transfer with polyethylene pipe.",
  ...
  app(
    ...
    "Pressurised farm mains and feeder lines for drip, sprinkler and field networks.",
  ...
  app(
    ...
    "Urban and rural gas service branches from steel transmission mains.",
  ...
  app(
    ...
    "Sanitary sewer collection for municipal and industrial wastewater.",
  ...
  app(
    ...
    "Surface water and storm runoff — not sanitary sewage.",
  ...
  app(
    ...
    "Fluid transfer in industrial processes where PE is specified.",
  ...
  app(
    ...
    "Ducting for telecom, power and fibre cable routes.",
    "PE cable protection",
    "HDPE cable duct",
